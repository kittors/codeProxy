...
const NAV_ITEMS = [
  ...
  { to: "/manage/identity-fingerprint", i18nKey: "shell.nav_identity_fingerprint", icon: Fingerprint },
...
const getPageTitleKey = (pathname: string): string => {
  ...
  if (pathname.startsWith("/identity-fingerprint") || pathname.startsWith("/manage/identity-fingerprint")) return "shell.nav_identity_fingerprint";
