...
function CodeBlock({ language, children }: { language: string; children: string }) {
  ...
  return (
    <div className="overflow-hidden rounded-xl my-3" style={{ border: "1px solid #3e4451" }}>
      <div className="flex items-center justify-between px-4 py-1.5" style={{ backgroundColor: "#282c34" }}>
      ...
      <SyntaxHighlighter
        ...
        style={oneDark}
        customStyle={{ margin: 0, borderRadius: 0, fontSize: "13px", lineHeight: "1.6", padding: "10px 16px 16px 16px" }}
