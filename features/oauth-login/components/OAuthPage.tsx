            ...
            >
              ...
              <div className="grid min-w-0 gap-3">
                <div className={[surface({ tone: "raised", radius: "2xl" }), "grid min-w-0 gap-2 p-4"].join(" ")}>
                  ...
                  <div className={[surface({ tone: "plain", radius: "xl" }), "min-w-0 overflow-hidden break-all px-3 py-2 font-mono text-xs text-slate-800 dark:text-slate-100"].join(" ")}>
                    {url ? url : "--"}
                  </div>
                    ...
                    {state.callbackStatus ? (
                      ...
                      >
                        {state.callbackStatus === "success"
                          ...
                          : state.callbackError ||
                            t("oauth.callback_submit_failed")}
                      </span>
                    ) : null}
                  </div>
                </div>
          ...
          actions={
            <label className="inline-flex">
              <input
                ...
                className="hidden"
                onChange={(e) =>
                  void onVertexFileChange(e.currentTarget.files?.[0] ?? null)
                }
              />
