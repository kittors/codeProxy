...
| `AuthFilesPage` | 111.85 kB | 29.85 kB | 仍是最大业务页面 chunk，继续拆到 600 行以内 |
...
| --- | ---: | --- | --- |
| `AuthFilesPage` | 111.85 kB / 29.85 kB gzip | 通过 | 主页面已从 4095 行降到 760 行，本轮再拆出 `useAuthFilesDataState`，但仍需继续拆到 600 行以内 |
