...
| `AuthFilesPage` | 111.66 kB | 29.76 kB | 仍是最大业务页面 chunk，继续拆到 600 行以内 |
...
| --- | ---: | --- | --- |
| `AuthFilesPage` | 111.66 kB / 29.76 kB gzip | 通过 | 主页面已从 4095 行降到 822 行，本轮再拆出 `useAuthFilesFileActions`，但仍需继续拆到 600 行以内 |
