...
| `AuthFilesPage` | 112.45 kB | 29.83 kB | 页面主文件已达行数目标，但 chunk 仍偏大 |
...
| --- | ---: | --- | --- |
| `AuthFilesPage` | 112.45 kB / 29.83 kB gzip | 通过 | 主页面已从 4095 行降到 460 行，本轮再拆出 `useAuthFilesQuotaState`，行数目标已完成，后续转向 chunk 和测试治理 |
